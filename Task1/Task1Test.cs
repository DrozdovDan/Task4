...
//    {
//        var ranges = LoadRanges(new List<string> { "C:/Users/Admin/RiderProjects/Class4/data1.iprs", "C:/Users/Admin/RiderProjects/Class4/data2.iprs" });
//        That(ranges, Is.EqualTo(new IPRangesDatabase(new List<IPRange>{new IPRange(new IPv4Addr("0.0.0.1"), new IPv4Addr("127.0.0.1")), new IPRange(new IPv4Addr("1.1.1.1"), new IPv4Addr("255.255.255.255"))})));
//    }
    ...
    public void LoadRangesEmptyTest()
    {
        ...
        That(FindRange(ranges, new IPv4Addr("60.161.226.166")), Is.EqualTo("60.161.226.166 NO"));
    }
    
    [Test]
    public void LoadFindRangeTest()
    {
        var ranges = LoadRanges(new List<string>{"C:/Users/Admin/RiderProjects/Class4/data1.iprs"});
//        That(FindRange(ranges, new IPv4Addr("255.161.255.166")), Is.EqualTo("260.161.226.166 NO"));
        That(FindRange(ranges, new IPv4Addr("127.0.0.1")), !Is.EqualTo("127.0.0.1 NO"));
    }
}